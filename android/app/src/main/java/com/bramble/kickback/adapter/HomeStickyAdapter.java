...
public class HomeStickyAdapter extends BaseAdapter implements StickyListHeadersAdapter {

    private List<Friend> filteredList = null;
    private ArrayList<Friend> arrayList;
    private LayoutInflater inflater;

    public HomeStickyAdapter(Context context, ArrayList<Friend> inputArrayList) {
